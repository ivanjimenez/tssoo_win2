...
public class UMLSheetLabelProvider extends BaseLabelProvider implements
	...
	public String getText(Object element) {
		...
		if (element instanceof umlMM.diagram.navigator.UMLNavigatorGroup) {
			return ((umlMM.diagram.navigator.UMLNavigatorGroup) element)
					.getGroupName();
		}
	...
	public Image getImage(Object element) {
		...
		return etype == null ? null : umlMM.diagram.providers.UMLElementTypes
				.getImage(etype);
	}
	...
	private IElementType getElementType(View view) {
		...
		while (view != null) {
			...
			IElementType etype = umlMM.diagram.providers.UMLElementTypes
					.getElementType(vid);
			if (etype != null) {
				return etype;
			}
