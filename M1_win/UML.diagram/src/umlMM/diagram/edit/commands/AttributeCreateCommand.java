...
public class AttributeCreateCommand extends EditElementCommand {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		umlMM.Attribute newElement = umlMM.UmlMMFactory.eINSTANCE
				.createAttribute();

		umlMM.Class owner = (umlMM.Class) getElementToEdit();
	 ...
	 * @generated
	 */
	protected void doConfigure(umlMM.Attribute newElement,
