...
public class UMLElementTypes {
	 ...
	 * @generated
	 */
	public static final IElementType Class_2001 = getElementType("UML.diagram.Class_2001"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType Datatype_2002 = getElementType("UML.diagram.Datatype_2002"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	public static final IElementType Attribute_3001 = getElementType("UML.diagram.Attribute_3001"); //$NON-NLS-1$
	/**
	 * @generated
	 */
	...
	public static ENamedElement getElement(IAdaptable hint) {
		...
		if (elements == null) {
			...
			elements.put(Class_2001, umlMM.UmlMMPackage.eINSTANCE.getClass_());

			elements.put(Datatype_2002,
					umlMM.UmlMMPackage.eINSTANCE.getDatatype());

			elements.put(Attribute_3001,
					umlMM.UmlMMPackage.eINSTANCE.getAttribute());
