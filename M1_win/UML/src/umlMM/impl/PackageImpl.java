...
public class PackageImpl extends EObjectImpl implements umlMM.Package {
	...
	public EList<Associaton> getAssociation() {
		if (association == null) {
			association = new EObjectContainmentWithInverseEList<Associaton>(Associaton.class, this, UmlMMPackage.PACKAGE__ASSOCIATION, UmlMMPackage.ASSOCIATON__NAMESPACE);
		}
		return association;
	}
